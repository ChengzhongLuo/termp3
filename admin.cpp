...
int main()
{
    ...
    const char* clientType = "ADMIN"; // Or "ADMIN" for admin client
    ...
    while (1) {
        ...
        if (queryStudentID.empty()) {
            cout << "Admin has sent " << queryDepartment << " to Main Server using TCP over port " << dyport << endl;
        } else {
            cout << "Admin has sent " << queryDepartment << " and Student " << queryStudentID << " to Main Server using TCP over port " << dyport << endl;
        }
